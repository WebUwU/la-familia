...
// Session
function getSession() { return JSON.parse(sessionStorage.getItem('lf_session') || 'null'); }
function setSession(u) { sessionStorage.setItem('lf_session', JSON.stringify(u)); }
function clearSession() { sessionStorage.removeItem('lf_session'); }
