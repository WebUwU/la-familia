...
async function initDB() {
  ...
  if (!mSnap.exists()) {
    await set(ref(db, 'members'), {
      m1: { rank: 12, icName: 'Carlos Mendoza', discord: 'carlos#0001', discordId: '100000000000000001', absence: null, sanctions: null, notes: '', subroles: null, warns: 0, pin: '1001' },
      m2: { rank: 11, icName: 'Diego Alvarez', discord: 'diego#0002', discordId: '100000000000000002', absence: null, sanctions: null, notes: '', subroles: null, warns: 0, pin: '1002' },
      m3: { rank: 8,  icName: 'Mateo Solis', discord: 'mateo#0003', discordId: '100000000000000003', absence: null, sanctions: null, notes: '', subroles: ['schuetzenteam', 'caller'], warns: 1, pin: '1003' },
      m4: { rank: 5,  icName: 'Luis Herrera', discord: 'luis#0004', discordId: '100000000000000004', absence: null, sanctions: { s1: { reason: 'Verwarnungsgespräch', until: '2026-04-01T20:00' } }, notes: 'Muss sich bessern', subroles: ['routenverwaltung'], warns: 2, pin: '1004' },
      m5: { rank: 3,  icName: 'Sofia Reyes', discord: 'sofia#0005', discordId: '100000000000000005', absence: null, sanctions: null, notes: '', subroles: null, warns: 0, pin: '1005' },
      m6: { rank: 1,  icName: 'Marco Perez', discord: 'marco#0006', discordId: '100000000000000006', absence: null, sanctions: null, notes: '', subroles: null, warns: 0, pin: '1006' },
      m7: { rank: 1,  icName: 'Elena Torres', discord: 'elena#0007', discordId: '100000000000000007', absence: { until: '2026-03-15T18:00', reason: 'Urlaub' }, sanctions: null, notes: '', subroles: null, warns: 0, pin: '1007' },
      m8: { rank: 2,  icName: 'Javier Cruz', discord: 'javier#0008', discordId: '100000000000000008', absence: null, sanctions: null, notes: '', subroles: ['sanktionsverwaltung'], warns: 3, pin: '1008' }
    });
  }
}
...
export { db, ref, set, get, push, onValue, remove, update, RANKS, SUBROLES, getSession, setSession, clearSession, esc, parseDMTime, formatDT, getSubroleLabels, initDB, generatePin };
